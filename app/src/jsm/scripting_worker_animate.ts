...
interface TrainBoogie {
    state?: number;
    currentCurveFac?: number;
    x?: number;
    y?: number;
    angle?: number;
}
interface TrainCar extends Object {
    width?: number;
    height?: number;
    x?: number;
    y?: number;
    displayAngle?: number;
    assetFlip?: boolean;
    konamiUseTrainIcon?: boolean;
    invisible?: boolean;
    opacity?: number;
    src: number;
    wheelFront2DSrc?: number;
    wheelFront3D?: boolean;
    wheelMoveX?: number;
    wheelMoveY?: number;
    wheelFrontLeftX?: number;
    wheelFrontLeftY?: number;
    wheelFrontRightX?: number;
    wheelFrontRightY?: number;
    wheelBack2DSrc?: number;
    wheelBack3D?: boolean;
    wheelBackLeftX?: number;
    wheelBackLeftY?: number;
    wheelBackRightX?: number;
    wheelBackRightY?: number;
    front?: TrainBoogie;
    back?: TrainBoogie;
}
export interface Train extends Object {
    x?: number;
    y?: number;
    width?: number;
    height?: number;
    ...
    currentSpeedInPercent?: number;
    accelerationSpeed?: number;
    accelerationSpeedCustom?: number;
...
interface TrainCalcCar extends TrainCar {
    fac: number;
    bogieDistance: number;
}
interface TrainCalc extends Train {
    state: number;
    fac: number;
    margin?: number;
    circleStartPosDiv?: number;
    bogieDistance: number;
    accelerationSpeedFac: number;
    accelerationSpeedStartFac: number;
    speed?: number;
    speedFac: number;
    endOfTrack?: boolean;
    endOfTrackStandardDirection?: boolean;
    trainTurned?: boolean | undefined;
    switchCircles?: boolean;
    standardDirectionStartValue: boolean;
    volumeCustom?: number;
    demoModeEquals?: number;
    demoModeMove?: boolean;
    cars: TrainCalcCar[];
}
...
interface RotationPointBezier extends RotationPoint {
    bezierLength: number;
}
interface RotationPointCircle extends RotationPoint {
    bezierLength: {left: number; right: number};
}
interface RotationPointsInner {
    narrow: RotationPointCircle;
    wide: RotationPointCircle;
    sidings: {first: RotationPointBezier; firstS1: RotationPoint; firstS2: RotationPointBezier; second: RotationPointBezier; secondS1: RotationPoint; secondS2: RotationPointBezier; third: RotationPointBezier; thirdS1: RotationPoint; thirdS2: RotationPointBezier};
}
interface RotationPointsOuter {
    narrow: RotationPointCircle;
    altState3: {left: RotationPointBezier; right: RotationPointBezier};
    rightSiding: {enter: RotationPoint; curve: RotationPointBezier; end: RotationPoint; continueCurve0: RotationPointBezier; continueLine0: RotationPointBezier; continueCurve1: RotationPointBezier; continueLine1: RotationPoint; continueCurve2: RotationPointBezier; rejoin: RotationPoint};
}
interface RotationPointsInner2Outer {
    left: RotationPointBezier;
    right: RotationPointBezier;
}
export interface RotationPoints {
    inner: RotationPointsInner;
    outer: RotationPointsOuter;
...
function defineTrainParams() {
    ...
    /////Rotation Points/////
    const repNo = 1000;
    const circles: RotationPointCircle[] = [];
    var bezierPoints;
...
function animateObjects() {
    ...
    var debugDrawPoints: TrainPoint[] = [];
    var debugDrawPointsCrash: TrainPoint[] = [];
