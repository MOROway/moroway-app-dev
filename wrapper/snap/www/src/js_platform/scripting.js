...
function placeOptions(state){
    ...
    if(state == "hide") {
        ...
        if(state == "load") {
            ...
            menu.items.exit = menu.items.help.cloneNode(true);
            menu.items.exit.id = "canvas-platform-exit";
            menu.items.exit.title = getString("platformSnapAppExit");
            menu.items.exit.querySelector("i").textContent = "close";
            menu.items.exit.addEventListener("click", _exitApp.exec);
            menu.container.appendChild(menu.items.exit);
            ...
            menu.items.exit = document.querySelector("#canvas-platform-exit");
        }
